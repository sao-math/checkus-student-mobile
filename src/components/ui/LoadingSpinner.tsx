...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({
  ...
  const containerClasses = cn(
    'flex items-center justify-center',
    {
      ...
      'min-h-96': fullHeight && !fullScreen,
      'p-8': fullScreen,
      'p-4': fullHeight && !fullScreen,
    },
    className
  );
...
/**
 * 대시보드용 로딩 스피너 (기존 패턴과 호환)
 */
export const DashboardLoadingSpinner: React.FC<{ text?: string }> = ({ text = "데이터를 불러오는 중..." }) => {
  return (
